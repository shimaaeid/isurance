            ...
            <div class="content">
                ...
                <div id="site-content">
                    ...
                    <div class="hero hero-slider">
                        <ul class="slides">
                            <li data-bg-image="{{ URL::asset('public/front/dummy/slide-1.jpg') }}">
                                <div class="container">
                            ...
                            <li data-bg-image="{{ URL::asset('public/front/dummy/slide-2.jpg') }}">
                                <div class="container">
                                    <div class="slide-content">
                                        <h2 class="slide-title">Get your <strong>Life Insurance</strong></h2>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repellendus quos cumque odio soluta harum error sequi laudantium, est nam perspiciatis eveniet maxime, esse possimus architecto sunt natus reprehenderit debitis fugit.</p>
                            ...
                            <li data-bg-image="{{ URL::asset('public/front/dummy/slide-3.jpg') }}">
                                <div class="container">
                                    <div class="slide-content">
                                        <h2 class="slide-title">Get your <strong>Life Insurance</strong></h2>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repellendus quos cumque odio soluta harum error sequi laudantium, est nam perspiciatis eveniet maxime, esse possimus architecto sunt natus reprehenderit debitis fugit.</p>
                    ...
                    <main class="main-content">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="offer caption-top">
                                            <img src="{{ URL::asset('public/front/dummy/offer-tall.jpg') }}" alt="offer 1">
                                            <div class="caption">
                                    ...
                                    <div class="col-md-9">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="offer caption-bottom">
                                                    <img src="{{ URL::asset('public/front/dummy/offer-1.jpg') }}" alt="offer 2">
                                                    <div class="caption">
                                            ...
                                            <div class="col-md-8">
                                                <div class="offer caption-bottom">
                                            <img src="{{ URL::asset('public/front/dummy/offer-wide.jpg') }}" alt="offer 3">
                                            <div class="caption">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="offer caption-bottom">
                                                    <img src="{{ URL::asset('public/front/dummy/offer-2.jpg') }}" alt="offer 2">
                                                    <div class="caption">
                                                        <h3 class="offer-title">Curabitur vehicula</h3>
                                                        <small>Conubia nostra per inceptos</small>
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="offer caption-bottom">
                                                    <img src="{{ URL::asset('public/front/dummy/offer-3.jpg') }}" alt="offer 2">
                                                    <div class="caption">
                                                        <h3 class="offer-title">Curabitur vehicula</h3>
                                                        <small>Conubia nostra per inceptos</small>
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="offer caption-bottom">
                                                    <img src="{{ URL::asset('public/front/dummy/offer-4.jpg') }}" alt="offer 2">
                                                    <div class="caption">
                                                        <h3 class="offer-title">Curabitur vehicula</h3>
                                                        <small>Conubia nostra per inceptos</small>
                                                    </div>
                        ...
                        <div class="fullwidth-block">
                            <div class="container">
                                ...
                                <div class="row news-list">
                                    <div class="col-md-4">
                                        <div class="news">
                                            <figure><img src="{{ URL::asset('public/front/dummy/featured-image-1.jpg') }}" alt=""></figure>
                                            <div class="date"><img src="{{ URL::asset('public/front/images/icon-calendar.png') }}" alt="">03/09/2014</div>
                                            <h2 class="entry-title"><a href="#">Donec laoreet non nec aliquam pellentesque interdum</a></h2>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="news">
                                            <figure><img src="{{ URL::asset('public/front/dummy/featured-image-2.jpg') }}" alt=""></figure>
                                            <div class="date"><img src="{{ URL::asset('public/front/images/icon-calendar.png') }}" alt="">03/09/2014</div>
                                            <h2 class="entry-title"><a href="#">Donec laoreet non nec aliquam pellentesque interdum</a></h2>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="news">
                                            <figure><img src="{{ URL::asset('public/front/dummy/featured-image-3.jpg') }}" alt=""></figure>
                                            <div class="date"><img src="{{ URL::asset('public/front/images/icon-calendar.png') }}" alt="">03/09/2014</div>
                                            <h2 class="entry-title"><a href="#">Donec laoreet non nec aliquam pellentesque interdum</a></h2>
                                        </div>
                                    </div>
                        ...
                        <div class="fullwidth-block">
                            <div class="container">
                                ...
                                <div class="partners">
                                    <a href="#"><img src="{{ URL::asset('public/front/dummy/money-logo.png') }}" alt=""></a>
                                    <a href="#"><img src="{{ URL::asset('public/front/dummy/nyt-logo.png') }}" alt=""></a>
                                    <a href="#"><img src="{{ URL::asset('public/front/dummy/forbes-logo.png') }}" alt=""></a>
                                    <a href="#"><img src="{{ URL::asset('public/front/dummy/wsj-logo.png') }}" alt=""></a>
                                    <a href="#"><img src="{{ URL::asset('public/front/dummy/bbs-logo.png') }}" alt=""></a>
                                </div> <!-- .partners -->
                            </div> <!-- .container -->
                        </div> <!-- .fullwidth-block -->
