						...
						<div class="container">
							...
							<div class="row">
								<div class="col-xs-12 col-sm-6 col-md-3">
									<div class="team">
										<figure class="team-image"><img src="{{ URL::asset('public/front/dummy/team-1.jpg') }}" alt=""></figure>
								...
								<div class="col-xs-12 col-sm-6 col-md-3">
									<div class="team">
										<figure class="team-image"><img src="{{ URL::asset('public/front/dummy/team-2.jpg') }}" alt=""></figure>
								...
								<div class="col-xs-12 col-sm-6 col-md-3">
									<div class="team">
										<figure class="team-image"><img src="{{ URL::asset('public/front/dummy/team-3.jpg') }}" alt=""></figure>
								...
								<div class="col-xs-12 col-sm-6 col-md-3">
									<div class="team">
										<figure class="team-image"><img src="{{ URL::asset('public/front/dummy/team-4.jpg') }}" alt=""></figure>
