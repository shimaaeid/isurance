...
@section('content')
                                    ...
                                    <div class=" tab-menu-heading">
                                        <div class="tabs-menu1">
                                            ...
                                            <ul class="nav panel-tabs main-nav-line">
                                                <li><a href="#tab4" class="nav-link active" data-toggle="tab">Employee
                                                        Details</a></li>
                                                ...
                                                <div class="card card-statistics">
                                                    <div class="card-body">
                                                        <a class="modal-effect btn btn-outline-primary btn-block"
                                                            ...
                                                            href="#modaldemo8">Add Relative</a>
                                                    ...
                                                    @foreach ($emp_relative as $emp_relative)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                data-id="{{ $emp_relative->id }}"
                                                                data-emp_id="{{ $employee->id }}"
                                                                data-name="{{ $emp_relative->name }}"
                                                                data-toggle="modal"
                                                                href="#exampleModal2"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="2">
                                                                <a class="btn btn-outline-success btn-sm" target="_blank"
                                                                    href="{{ url('view_file') }}/{{ $employee->id }}/{{ $media->image }}"
                                                                    role="button">
                                                                    <i class="fas fa-eye">&nbsp;</i>عرض
                                                                </a>

                                                                <a class="btn btn-outline-info btn-sm"
                                                                    href="{{ url('download') }}/{{ $employee->id }}/{{ $media->image }}"
                                                                    role="button">
                                                                ...
                                                                <button class="btn btn-outline-danger btn-sm"
                                                                    data-toggle="modal" data-media_id="{{ $media->id }}"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">Delete Relative</h6><button aria-label="Close" class="close" data-dismiss="modal"
                                                                   type="button"><span aria-hidden="true">&times;</span></button>
                </div>
                <form action="{{ route('emp_relatives.destroy', 'test') }}" method="post">
                    {{method_field('delete')}}
                    {{csrf_field()}}
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit Relative Details</h5>
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('emp_relatives.update', 'test') }}" method="post" autocomplete="off">
                    {{method_field('patch')}}
                    {{csrf_field()}}
                    <div class="form-group">
                        <input type="hidden" name="id" id="id" value="">
                        <input type="hidden" name="emp_id" id="emp_id" value="">
                        <label for="recipient-name" class="col-form-label"> Relative Name :</label>
                    ...
                    <div class="form-group">
                        ...
                        <select name="relative_id" id="relative_id" class="form-control" required>
                            <option value="{{ $emp_relative->relative->id }}">{{ $emp_relative->relative->name }}</option>
...
<!-- end edit -->
    ...
    <div class="modal" id="modaldemo8">
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">Add Relative</h6><button aria-label="Close" class="close" data-dismiss="modal"
                        type="button"><span aria-hidden="true">&times;</span></button>
                </div>
