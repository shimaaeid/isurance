                        ...
                        <div class="col-sm-6 col-md-4 col-xl-3">
                            @can('add-emp')
                                ...
                                <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-scale"
                                    data-toggle="modal" href="#modaldemo8">Add Employee</a>
                            ...
                            <tbody>
                                @foreach ($employee as $employee)
                                    <tr>
                                        <td>{{ $employee->id }}</td>
                                        <td><a
                                                href="{{ url('employeeDetails') }}/{{ $employee->id }}">{{ $employee->name }}</a>
                                        </td>
                                        <td>{{ $employee->Job_number }}</td>
                                        <td>{{ $employee->Job_title }}</td>
                                        <td>
                                            <a href="{{ url('emp_edit') }}/{{ $employee->id }}" class=" btn btn-sm btn-info">Edit</a>

                                            {{-- <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                                data-id="{{ $employee->id }}"
                                                data-name="{{ $employee->name }}"
                                                data-Job_number="{{ $employee->Job_number }}"
                                                data-Job_title="{{ $employee->Job_title }}"
                                                data-toggle="modal"
                                                href="#exampleModal2" title="Edit"><i class="las la-pen"></i>Edit</a> --}}
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">Add Employee</h6><button aria-label="Close" class="close"
             ...
             <div class="modal-content">
                 ...
                 <div class="modal-body">
                     ...
                     <form action="products/update" method="post" autocomplete="off">
                         ...
                         <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Job Number</label>
                            <input class="form-control" name="Job_number" id="Job_number" type="number" value="455444">
                        </div>
...
@section('js')
    ...
    <script>
        $('#exampleModal2').on('show.bs.modal', function(event) {
            ...
            var Job_number = button.data('Job_number')
            var Job_title = button.data('Job_title')

            var modal = $(this)
            modal.find('.modal-body #id').val(id);
            modal.find('.modal-body #name').val(name);
            modal.find('.modal-body #Job_number').val(Job_number);
